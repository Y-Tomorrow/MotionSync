...
### txt-COCO JSON
```bash
 python txt_coco_json.py --mode txt2coco \
  --img_dir ./datasets/images/train \
  --txt_dir ./datasets/labels/train \
  --save_dir ./datasets/labels_json/train_coco.json
 python txt_coco_json.py --mode coco2txt \
  --json_path ./datasets/labels_json/test_1-1.json \
